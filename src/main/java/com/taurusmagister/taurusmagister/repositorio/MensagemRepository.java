...
public interface MensagemRepository extends JpaRepository<Mensagem, Integer> {
    ...
    @Query("select new com.taurusmagister.taurusmagister.resposta.MensagemInfo(m.idMensagem, m.fkUsuarioMentor.idUsuario, m.mensagem, m.date) from Mensagem m where m.fkUsuarioMentor.idUsuario = ?1 and m.fkUsuarioMentorado.idUsuario = ?2")
